...
int main() {
	...
	pqt.setEther_type('a');
	std::cout << pqt.toString() << std::endl << std::endl << std::endl << std::endl;
	...
	std::cout << pqt2.toString() << std::endl << std::endl << std::endl << std::endl;
	...
	std::cout << pqt3.toString() << std::endl << std::endl;
	ARP<Ethernet> pqt4(pqt3);
	pqt4.setSpa("192.168.0.14");
	std::cout << pqt4.toString() << std::endl << std::endl << std::endl << std::endl;
	...
	std::cout << pqt5.toString() << std::endl;
}
